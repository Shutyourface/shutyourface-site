      ...
      <div className="mx-auto max-w-[1500px] px-3 py-4">
        {showHistoryToggle && (
          <div className="mb-5 mx-auto flex w-full max-w-4xl gap-2">
            ...
            <a href={`/history/${todayDate}`} className="flex flex-1 items-center justify-center gap-2 border-2 border-red-700 bg-red-700 py-3 font-tabloid text-2xl uppercase text-white hover:bg-red-800">
              <span>⏱</span>
