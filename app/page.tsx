      ...
      <div className="mx-auto max-w-[1500px] px-3 py-4">
        {showHistoryToggle && (
          <div className="mb-5 flex w-fit gap-2">
            <span className="border-2 border-black bg-black px-6 py-3 text-center font-tabloid text-2xl uppercase text-white">
              Today&apos;s News
            </span>
            <a href={`/history/${todayDate}`} className="flex items-center gap-2 border-2 border-red-700 bg-red-700 px-6 py-3 font-tabloid text-xl uppercase text-white hover:bg-red-800">
              <span>⏱</span>
