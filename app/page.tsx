      ...
      <div className="mx-auto max-w-[1500px] px-3 py-4">
        {showHistoryToggle && (
          <div className="mb-5 flex justify-center gap-1">
            <span className="flex items-center whitespace-nowrap border-2 border-black bg-black px-10 py-3 font-tabloid text-2xl uppercase text-white">
              Today&apos;s News
            </span>
            <a href={`/history/${todayDate}`} className="flex items-center gap-2 whitespace-nowrap border-2 border-red-700 bg-red-700 px-8 py-3 font-tabloid text-2xl uppercase text-white hover:bg-red-800">
              <span>⏱</span>
